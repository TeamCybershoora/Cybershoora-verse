  ...
  <section id="footer">
    <div className="top">
      <div className="footer-section">
        <img className="logo" src="https://ik.imagekit.io/cybershoora/Shooraverse/Logos%20of%20Web%20Panel%20or%20Web%20aap/Shooraverse-text.svg?updatedAt=1750497732898" style={{width: '100%'}} alt="" />
    ...
    <div className="bottom">
      <h1 className="copyright-text">
        Copyright &copy; 2025 Shooraverse . <br /> All Rights Reserved.
      </h1>
    </div>
  </section>
);
