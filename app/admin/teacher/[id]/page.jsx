    ...
    const fetchTeacherData = async () => {
      try {
        ...
        if (data.success) {
          ...
          setError(data.message || 'Failed to fetch teacher data');
        }
      } catch (err) {
  ...
  return (
    <div className="container">
      ...
      <div className="header">
        <h1 className="header-title">Teacher Profile</h1>
        <button 
          onClick={handleBackToDashboard}
          className="back-button"
        >
      ...
      <div className="main-content">
        ...
        <div className="profile-photo-section">
          <div className="profile-photo-container">
            <img 
              src={teacher.profilePhoto || '/assets/Shoora-logo.svg'} 
          ...
          <div className="profile-id-name">
            <div className="id-card-badge">
              Teacher ID: {teacher.idCardNumber || 'Not Assigned'}
            </div>
          ...
          <div className="status-row">
            <div className={`status-container ${teacher.status === 'active' ? 'enrolled-status' : 'trial-status'}`}>
              <div className={teacher.status === 'active' ? 'enrolled-text' : 'trial-text'}>
          ...
          <div className="info-grid">
            ...
            <div className="info-section">
              ...
              <div className="field-grid">
                <InfoField label="Teacher Name" value={teacher.fullName} />
                <InfoField label="Date of Birth" value={teacher.dob} />
                <InfoField label="Email Address" value={teacher.email} />
                <InfoField label="Mobile Number" value={teacher.phone} />
                <InfoField label="Home Address" value={teacher.address} />
                <InfoField label="Educational Qualification" value={teacher.qualification} />
              </div>
            </div>
            ...
            <div className="info-section">
              ...
              <div className="field-grid">
                <InfoField label="Teacher ID Number" value={teacher.teacherCode} />
                <InfoField label="Registration Date" value={teacher.createdAt} />
                <InfoField label="Last Profile Update" value={teacher.updatedAt} />
                <InfoField label="Login Password" value={teacher.password} isPassword={true} />
              </div>
            </div>
          </div>
        </div>
